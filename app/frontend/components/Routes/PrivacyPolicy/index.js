  ...
  render() {
    return (
      <div className="content is-size-7" style={{ lineHeight: "1.8" }}>
        ...
        <p>
          rechord (以下、本サービス) では、サイトのサービスの分析と改善のために Google アナリティクスを使用しています。
        ...
        <p>
          ...
          利用者さまが本サービスや他のウェブサイトに 過去にアクセスした際の情報に基づいて広告を配信します。
          そして Google が広告 Cookie を使用することにより、利用者さまが本サービスや他のウェブサイトにアクセスした際の情報に基づいて、
          Google やそのパートナーが適切な広告を 利用者さまに表示することができます。
          Googleによるこれらのパーソナライズ広告は、利用者さまの判断で停止することができます。
          望まれる方は、
